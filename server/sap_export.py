...
rewrite, a successful call already means SAP has done the MIGO 501 stock receipt
...
def export_to_sap(record: dict, matnr, *, board_length_cm, board_width_cm, product_area_cm2,
    ...
    board_length_cm/board_width_cm/product_area_cm2 likewise come from the
    caller's own design-measurement result, never recomputed here.

    charg is no longer accepted -- the batch is assigned by SAP's own MIGO 501
